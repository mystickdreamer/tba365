...
static void fry_victim(struct char_data *ch)
{
  ...
  case 7:
    ...
    cast_spell(ch, tch, 0, SPELL_FIREBALL, NULL);
    break;
  default:
    if (!rand_number(0, 1))
      cast_spell(ch, ch, 0, SPELL_HEAL, NULL);
    break;
  }
