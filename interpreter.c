...
cpp_extern const struct command_info cmd_info[] = {
    ...
    /* now, the main list */
    { "at", "at", POS_DEAD, do_at, ADMLVL_IMMORT, 0},
    { "advance", "adv", POS_DEAD, do_advance, ADMLVL_GRGOD, 0},
...
//    { "artisan", "art", POS_DEAD, do_artisan, 0, ADMLVL_NONE, 0},
    ...
    { "attach", "attach", POS_DEAD, do_attach, ADMLVL_BUILDER, 0},
    ...
    { "ban", "ban", POS_DEAD, do_ban, ADMLVL_GRGOD, 0},
    { "balance", "bal", POS_STANDING, do_not_here, 1, 0},
    { "bash", "bas", POS_FIGHTING, do_bash, 1, 0},
    { "brief", "br", POS_DEAD, do_gen_tog, 0, SCMD_BRIEF},
    { "buildwalk", "buildwalk", POS_STANDING, do_gen_tog, ADMLVL_BUILDER, SCMD_BUILDWALK},
    { "buy", "bu", POS_STANDING, do_not_here, 0, 0},
    { "bug", "bug", POS_DEAD, do_ibt, 0, SCMD_BUG},

    { "cast", "c", POS_SITTING, do_cast, 1, 0},
    { "cedit", "cedit", POS_DEAD, do_oasis_cedit, ADMLVL_IMPL, 0},
    { "changelog", "cha", POS_DEAD, do_changelog, ADMLVL_IMPL, 0},
    { "check", "ch", POS_STANDING, do_not_here, 1, 0},
    { "checkload", "checkl", POS_DEAD, do_checkloadstatus, ADMLVL_GOD, 0},
    ...
    { "copyover", "copyover", POS_DEAD, do_copyover, ADMLVL_GRGOD, 0},
    { "credits", "cred", POS_DEAD, do_gen_ps, 0, SCMD_CREDITS},

    { "date", "da", POS_DEAD, do_date, ADMLVL_IMMORT, SCMD_DATE},
    { "dc", "dc", POS_DEAD, do_dc, ADMLVL_GOD, 0},
    { "deposit", "depo", POS_STANDING, do_not_here, 1, 0},
    { "detach", "detach", POS_DEAD, do_detach, ADMLVL_BUILDER, 0},
    { "diagnose", "diag", POS_RESTING, do_diagnose, 0, 0},
    { "dig", "dig", POS_DEAD, do_dig, ADMLVL_BUILDER, 0},
    ...
    { "echo", "ec", POS_SLEEPING, do_echo, ADMLVL_IMMORT, SCMD_ECHO},
    ...
    { "export", "export", POS_DEAD, do_export_zone, ADMLVL_IMPL, 0},

    { "force", "force", POS_SLEEPING, do_force, ADMLVL_GOD, 0},
    { "fill", "fil", POS_STANDING, do_pour, 0, SCMD_FILL},
    { "file", "file", POS_SLEEPING, do_file, ADMLVL_GOD, 0},
    { "flee", "fl", POS_FIGHTING, do_flee, 1, 0},
    { "follow", "fol", POS_RESTING, do_follow, 0, 0},
    { "freeze", "freeze", POS_DEAD, do_wizutil, ADMLVL_GRGOD, SCMD_FREEZE},

    { "get", "g", POS_RESTING, do_get, 0, 0},
    { "gecho", "gecho", POS_DEAD, do_gecho, ADMLVL_GOD, 0},
    { "gemote", "gem", POS_SLEEPING, do_gen_comm, 0, SCMD_GEMOTE},
    { "give", "giv", POS_RESTING, do_give, 0, 0},
    { "goto", "go", POS_SLEEPING, do_goto, ADMLVL_IMMORT, 0},
    ...
    { "hedit", "hedit", POS_DEAD, do_oasis_hedit, ADMLVL_GOD, 0},
    { "helpcheck", "helpch", POS_DEAD, do_helpcheck, ADMLVL_GOD, 0},
    { "hide", "hi", POS_RESTING, do_hide, 1, 0},
    { "hindex", "hind", POS_DEAD, do_hindex, 0, 0},
    { "handbook", "handb", POS_DEAD, do_gen_ps, ADMLVL_IMMORT, SCMD_HANDBOOK},
    { "hcontrol", "hcontrol", POS_DEAD, do_hcontrol, ADMLVL_GRGOD, 0},
    ...
    { "holylight", "holy", POS_DEAD, do_gen_tog, ADMLVL_IMMORT, SCMD_HOLYLIGHT},
    ...
    { "imotd", "imo", POS_DEAD, do_gen_ps, ADMLVL_IMMORT, SCMD_IMOTD},
    { "immlist", "imm", POS_DEAD, do_gen_ps, 0, SCMD_IMMLIST},
    { "info", "info", POS_SLEEPING, do_gen_ps, 0, SCMD_INFO},
    { "invis", "invi", POS_DEAD, do_invis, ADMLVL_IMMORT, 0},
    ...
    { "last", "last", POS_DEAD, do_last, ADMLVL_GOD, 0},
    { "leave", "lea", POS_STANDING, do_leave, 0, 0},
    { "levels", "lev", POS_DEAD, do_levels, 0, 0},
    { "list", "lis", POS_STANDING, do_not_here, 0, 0},
    { "links", "lin", POS_STANDING, do_links, ADMLVL_GOD, 0},
    { "lock", "loc", POS_SITTING, do_gen_door, 0, SCMD_LOCK},
    { "load", "load", POS_DEAD, do_load, ADMLVL_BUILDER, 0},

    { "motd", "motd", POS_DEAD, do_gen_ps, 0, SCMD_MOTD},
    { "mail", "mail", POS_STANDING, do_not_here, 1, 0},
    { "map", "map", POS_STANDING, do_map, 1, 0},
    { "medit", "med", POS_DEAD, do_oasis_medit, ADMLVL_BUILDER, 0},
    { "mlist", "mlist", POS_DEAD, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_MLIST},
    { "mcopy", "mcopy", POS_DEAD, do_oasis_copy, ADMLVL_GOD, CON_MEDIT},
    { "msgedit", "msgedit", POS_DEAD, do_msgedit, ADMLVL_GOD, 0},
    { "mute", "mute", POS_DEAD, do_wizutil, ADMLVL_GOD, SCMD_MUTE},
    ...
    { "nohassle", "nohassle", POS_DEAD, do_gen_tog, ADMLVL_IMMORT, SCMD_NOHASSLE},
    ...
    { "notitle", "notitle", POS_DEAD, do_wizutil, ADMLVL_GOD, SCMD_NOTITLE},
    { "nowiz", "nowiz", POS_DEAD, do_gen_tog, ADMLVL_IMMORT, SCMD_NOWIZ},

    { "open", "o", POS_SITTING, do_gen_door, 0, SCMD_OPEN},
    { "order", "ord", POS_RESTING, do_order, 1, 0},
    { "offer", "off", POS_STANDING, do_not_here, 1, 0},
    { "olc", "olc", POS_DEAD, do_show_save_list, ADMLVL_BUILDER, 0},
    { "olist", "olist", POS_DEAD, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_OLIST},
    { "oedit", "oedit", POS_DEAD, do_oasis_oedit, ADMLVL_BUILDER, 0},
    { "oset", "oset", POS_DEAD, do_oset, ADMLVL_BUILDER, 0},
    { "ocopy", "ocopy", POS_DEAD, do_oasis_copy, ADMLVL_GOD, CON_OEDIT},

    { "put", "p", POS_RESTING, do_put, 0, 0},
    { "peace", "pe", POS_DEAD, do_peace, ADMLVL_BUILDER, 0},
    { "pick", "pi", POS_STANDING, do_gen_door, 1, SCMD_PICK},
    { "practice", "pr", POS_RESTING, do_practice, 1, 0},
    { "page", "pag", POS_DEAD, do_page, 1, 0},
    { "pardon", "pardon", POS_DEAD, do_wizutil, ADMLVL_GOD, SCMD_PARDON},
    { "plist", "plist", POS_DEAD, do_plist, ADMLVL_GOD, 0},
    ...
    { "purge", "purge", POS_DEAD, do_purge, ADMLVL_BUILDER, 0},

    { "qedit", "qedit", POS_DEAD, do_oasis_qedit, ADMLVL_BUILDER, 0},
    { "qlist", "qlist", POS_DEAD, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_QLIST},
    { "quaff", "qua", POS_RESTING, do_use, 0, SCMD_QUAFF},
    { "qecho", "qec", POS_DEAD, do_qcomm, ADMLVL_GOD, SCMD_QECHO},
    ...
    { "reload", "reload", POS_DEAD, do_reboot, ADMLVL_IMPL, 0},
    { "recite", "reci", POS_RESTING, do_use, 0, SCMD_RECITE},
    { "receive", "rece", POS_STANDING, do_not_here, 1, 0},
    { "recent", "recent", POS_DEAD, do_recent, ADMLVL_IMMORT, 0},
...
//    { "resetartisanexp", "resetart", POS_DEAD, do_resetartisan, 1, ADMLVL_GOD, 0},
    ...
    { "redit", "redit", POS_DEAD, do_oasis_redit, ADMLVL_BUILDER, 0},
    { "rlist", "rlist", POS_DEAD, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_RLIST},
    { "rcopy", "rcopy", POS_DEAD, do_oasis_copy, ADMLVL_GOD, CON_REDIT},
    { "roomflags", "roomflags", POS_DEAD, do_gen_tog, ADMLVL_IMMORT, SCMD_SHOWVNUMS},
    ...
    { "skills", "ski", POS_DEAD, do_skills, 0, 0 },
    { "scopy", "scopy", POS_DEAD, do_oasis_copy, ADMLVL_GOD, CON_SEDIT},
    { "sit", "si", POS_RESTING, do_sit, 0, 0},
    { "'", "'", POS_RESTING, do_say, 0, 0},
    { "save", "sav", POS_SLEEPING, do_save, 0, 0},
    { "saveall", "saveall", POS_DEAD, do_saveall, ADMLVL_BUILDER, 0},
    { "sell", "sell", POS_STANDING, do_not_here, 0, 0},
    { "sedit", "sedit", POS_DEAD, do_oasis_sedit, ADMLVL_BUILDER, 0},
    { "send", "send", POS_SLEEPING, do_send, ADMLVL_GOD, 0},
    { "set", "set", POS_DEAD, do_set, ADMLVL_IMMORT, 0},
    { "shout", "sho", POS_RESTING, do_gen_comm, 0, SCMD_SHOUT},
    { "show", "show", POS_DEAD, do_show, ADMLVL_IMMORT, 0},
    { "shutdow", "shutdow", POS_DEAD, do_shutdown, ADMLVL_IMPL, 0},
    { "shutdown", "shutdown", POS_DEAD, do_shutdown, ADMLVL_IMPL, SCMD_SHUTDOWN},
    { "sip", "sip", POS_RESTING, do_drink, 0, SCMD_SIP},
    { "skillset", "skillset", POS_SLEEPING, do_skillset, ADMLVL_GRGOD, 0},
    { "sleep", "sl", POS_SLEEPING, do_sleep, 0, 0},
    { "slist", "slist", POS_SLEEPING, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_SLIST},
    { "sneak", "sneak", POS_STANDING, do_sneak, 1, 0},
    { "snoop", "snoop", POS_DEAD, do_snoop, ADMLVL_GOD, 0},
    { "socials", "socials", POS_DEAD, do_commands, 0, SCMD_SOCIALS},
    { "split", "split", POS_SITTING, do_split, 1, 0},
    { "stand", "st", POS_RESTING, do_stand, 0, 0},
    { "stat", "stat", POS_DEAD, do_stat, ADMLVL_IMMORT, 0},
    { "steal", "ste", POS_STANDING, do_steal, 1, 0},
    { "switch", "switch", POS_DEAD, do_switch, ADMLVL_GOD, 0},

    { "tell", "t", POS_DEAD, do_tell, 0, 0},
    { "take", "ta", POS_RESTING, do_get, 0, 0},
    { "taste", "tas", POS_RESTING, do_eat, 0, SCMD_TASTE},
    { "teleport", "tele", POS_DEAD, do_teleport, ADMLVL_BUILDER, 0},
    { "tedit", "tedit", POS_DEAD, do_tedit, ADMLVL_GOD, 0}, /* XXX: Oasisify */
    { "thaw", "thaw", POS_DEAD, do_wizutil, ADMLVL_GRGOD, SCMD_THAW},
    ...
    { "transfer", "transfer", POS_SLEEPING, do_trans, ADMLVL_GOD, 0},
    { "trigedit", "trigedit", POS_DEAD, do_oasis_trigedit, ADMLVL_BUILDER, 0},
    { "typo", "typo", POS_DEAD, do_ibt, 0, SCMD_TYPO},
    { "tlist", "tlist", POS_DEAD, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_TLIST},
    { "tcopy", "tcopy", POS_DEAD, do_oasis_copy, ADMLVL_GOD, CON_TRIGEDIT},
    { "tstat", "tstat", POS_DEAD, do_tstat, ADMLVL_BUILDER, 0},

    { "unlock", "unlock", POS_SITTING, do_gen_door, 0, SCMD_UNLOCK},
    { "unban", "unban", POS_DEAD, do_unban, ADMLVL_GRGOD, 0},
    { "unaffect", "unaffect", POS_DEAD, do_wizutil, ADMLVL_GOD, SCMD_UNAFFECT},
    { "uptime", "uptime", POS_DEAD, do_date, ADMLVL_GOD, SCMD_UPTIME},
    { "use", "use", POS_SITTING, do_use, 1, SCMD_USE},
    { "users", "users", POS_DEAD, do_users, ADMLVL_GOD, 0},
    ...
    { "vnum", "vnum", POS_DEAD, do_vnum, ADMLVL_IMMORT, 0},
    { "vstat", "vstat", POS_DEAD, do_vstat, ADMLVL_IMMORT, 0},
    { "vdelete", "vdelete", POS_DEAD, do_vdelete, ADMLVL_BUILDER, 0},
    ...
    { "wiznet", "wiz", POS_DEAD, do_wiznet, ADMLVL_IMMORT, 0},
    { ";", ";", POS_DEAD, do_wiznet, ADMLVL_IMMORT, 0},
    { "wizhelp", "wizhelp", POS_SLEEPING, do_commands, ADMLVL_IMMORT, SCMD_WIZHELP},
    { "wizlist", "wizlist", POS_DEAD, do_gen_ps, 0, SCMD_WIZLIST},
    { "wizupdate", "wizupde", POS_DEAD, do_wizupdate, ADMLVL_GRGOD, 0},
    { "wizlock", "wizlock", POS_DEAD, do_wizlock, ADMLVL_IMPL, 0},
    { "write", "write", POS_STANDING, do_write, 1, 0},

    { "zreset", "zreset", POS_DEAD, do_zreset, ADMLVL_BUILDER, 0},
    { "zedit", "zedit", POS_DEAD, do_oasis_zedit, ADMLVL_BUILDER, 0},
    { "zlist", "zlist", POS_DEAD, do_oasis_list, ADMLVL_BUILDER, SCMD_OASIS_ZLIST},
