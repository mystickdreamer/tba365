...
#define IS_GOD(ch)		(!IS_NPC(ch) && (GET_ADMLEVEL(ch) >= ADMLVL_GOD))
...
#define NOTRADE_MAGIC_USER(i)	(IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOMAGIC_USER))
#define NOTRADE_CLERIC(i)	(IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOCLERIC))
#define NOTRADE_THIEF(i)	(IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOTHIEF))
#define NOTRADE_WARRIOR(i)	(IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOWARRIOR))
