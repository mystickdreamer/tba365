    ...
    if (IS_SET(SINFO.routines, MAG_MANUAL))
        switch (spellnum) {
            ...
            case SPELL_CREATE_WATER: MANUAL_SPELL(spell_create_water);
                break;
            case SPELL_DETECT_POISON: MANUAL_SPELL(spell_detect_poison);
                break;
            case SPELL_ENCHANT_WEAPON: MANUAL_SPELL(spell_enchant_weapon);
                break;
...
void mag_assign_spells(void) {
    ...
    set_skill_type(SKILL_BACKSTAB, SKTYPE_SKILL);
    ...
    set_skill_type(SK_MEDIUM_EDGED, SKTYPE_WEAPON);
    skillo(SK_HEAVY_EDGED, "heavy edged");
    set_skill_type(SK_HEAVY_EDGED, SKTYPE_WEAPON);
    skillo(SK_SMALL_BLUNT, "small blunt");
    set_skill_type(SK_SMALL_BLUNT, SKTYPE_WEAPON);
    skillo(SK_MEDIUM_BLUNT, "medium blunt");
    set_skill_type(SK_MEDIUM_BLUNT, SKTYPE_WEAPON);
    skillo(SK_HEAVY_BLUNT, "heavy blunt");
    set_skill_type(SK_HEAVY_BLUNT, SKTYPE_WEAPON);
    skillo(SK_STAFF, "staff");
    set_skill_type(SK_STAFF, SKTYPE_WEAPON);
    skillo(SK_SLING, "sling");
    set_skill_type(SK_SLING, SKTYPE_WEAPON);
    skillo(SK_SHORT_BOW, "short bow");
    set_skill_type(SK_SHORT_BOW, SKTYPE_WEAPON);
    skillo(SK_LONG_BOW, "long bow");
    set_skill_type(SK_LONG_BOW, SKTYPE_WEAPON);
    skillo(SK_LIGHT_CROSSBOW, "light crossbow");
    set_skill_type(SK_LIGHT_CROSSBOW, SKTYPE_WEAPON);
    skillo(SK_HEAVY_CROSSBOW, "heavy crossbow");
    set_skill_type(SK_HEAVY_CROSSBOW, SKTYPE_WEAPON);
    skillo(SK_POLEARM, "polearm");
    set_skill_type(SK_POLEARM, SKTYPE_WEAPON);
    skillo(SK_LIGHT_THROWN, "light thrown");
    set_skill_type(SK_LIGHT_THROWN, SKTYPE_WEAPON);
    skillo(SK_HEAVY_THROWN, "heavy thrown");
    set_skill_type(SK_HEAVY_THROWN, SKTYPE_WEAPON);
    skillo(SK_BACKSTAB, "backstab");
    set_skill_type(SK_BACKSTAB, SKTYPE_WEAPON);
    //Survival:
    skillo(SK_EVASION, "evasion");
    set_skill_type(SK_EVASION, SKTYPE_SURVIVAL);
    skillo(SK_CLIMBING, "climbing");
    set_skill_type(SK_CLIMBING, SKTYPE_SURVIVAL);
    skillo(SK_SWIMMING, "swimming");
    set_skill_type(SK_SWIMMING, SKTYPE_SURVIVAL);
    skillo(SK_PERCEPTION, "perception");
    set_skill_type(SK_PERCEPTION, SKTYPE_SURVIVAL);
    skillo(SK_TRACKING, "tracking");
    set_skill_type(SK_TRACKING, SKTYPE_SURVIVAL);
    skillo(SK_HIDING, "hiding");
    set_skill_type(SK_HIDING, SKTYPE_SURVIVAL);
    skillo(SK_SNEAKING, "sneaking");
    set_skill_type(SK_SNEAKING, SKTYPE_SURVIVAL);
    skillo(SK_LOCKPICKING, "lockpicking");
    set_skill_type(SK_LOCKPICKING, SKTYPE_SURVIVAL);
    skillo(SK_DISARMING, "disarming");
    set_skill_type(SK_DISARMING, SKTYPE_SURVIVAL);
    skillo(SK_STEALING, "stealing");
    set_skill_type(SK_STEALING, SKTYPE_SURVIVAL);
    skillo(SK_FIRST_AID, "first aid");
    set_skill_type(SK_FIRST_AID, SKTYPE_SURVIVAL);
    //Lore:
    skillo(SK_SCHOLARSHIP, "scholarship");
    set_skill_type(SK_SCHOLARSHIP, SKTYPE_LORE);
    skillo(SK_MUSIC, "music");
    set_skill_type(SK_MUSIC, SKTYPE_LORE);
    //Instrumental Lore: (Bards)
    skillo(SK_PERCUSSION, "percussion");
    set_skill_type(SK_PERCUSSION, SKTYPE_LORE);
    skillo(SK_STRINGED, "stringed instrument");
    set_skill_type(SK_STRINGED, SKTYPE_LORE);
    skillo(SK_WIND, "wind instrument");
    set_skill_type(SK_WIND, SKTYPE_LORE);
    skillo(SK_VOCAL, "vocal");
    set_skill_type(SK_VOCAL, SKTYPE_LORE);
    skillo(SK_APPRAISE, "appraisal");
    set_skill_type(SK_APPRAISE, SKTYPE_LORE);
    skillo(SK_HANDLE_ANIMAL, "handle animal");
    set_skill_type(SK_HANDLE_ANIMAL, SKTYPE_LORE);
    skillo(SK_ASTROLOGY, "astrology");
    set_skill_type(SK_ASTROLOGY, SKTYPE_LORE);
    //Magic:
    skillo(SK_PRIMARY, "primary magic");
    set_skill_type(SK_PRIMARY, SKTYPE_MAGIC);
    skillo(SK_HARNESS, "harness magic");
    set_skill_type(SK_HARNESS, SKTYPE_MAGIC);
    skillo(SK_MANA_PERCEIVE, "mana perceive");
    set_skill_type(SK_MANA_PERCEIVE, SKTYPE_MAGIC);
    skillo(SK_MAGIC_DEVICES, "magic devices");
    set_skill_type(SK_MAGIC_DEVICES, SKTYPE_MAGIC);
    skillo(SK_TARGETED, "targeted magic");
    set_skill_type(SK_TARGETED, SKTYPE_MAGIC);
    //Armor:
    skillo(SK_SHIELD, "shield");
    set_skill_type(SK_SHIELD, SKTYPE_ARMOR);
    skillo(SK_LEATHER, "leather armor");
    set_skill_type(SK_LEATHER, SKTYPE_ARMOR);
    skillo(SK_CHAIN, "chain mail");
    set_skill_type(SK_CHAIN, SKTYPE_ARMOR);
    skillo(SK_PLATE, "plate mail");
    set_skill_type(SK_PLATE, SKTYPE_ARMOR);
    //Crafting:
    skillo(SK_MINING, "mining");
    set_skill_type(SK_MINING, SKTYPE_CRAFTING);
    skillo(SK_FORAGING, "foraging");
    set_skill_type(SK_FORAGING, SKTYPE_CRAFTING);
    skillo(SK_SKINNING, "skinning");
    set_skill_type(SK_SKINNING, SKTYPE_CRAFTING);
    skillo(SK_HERBALISM, "herbalism");
    set_skill_type(SK_HERBALISM, SKTYPE_CRAFTING);
    skillo(SK_FORESTRY, "forestry");
    set_skill_type(SK_FORESTRY, SKTYPE_CRAFTING);
    skillo(SK_COOKING, "cooking");
    set_skill_type(SK_COOKING, SKTYPE_CRAFTING);
    skillo(SK_BLACKSMITHING, "blacksmithing");
    set_skill_type(SK_BLACKSMITHING, SKTYPE_CRAFTING);
    skillo(SK_TAILORING, "tailoring");
    set_skill_type(SK_TAILORING, SKTYPE_CRAFTING);
    skillo(SK_TANNING, "tanning");
    set_skill_type(SK_TANNING, SKTYPE_CRAFTING);
    skillo(SK_GOLDSMITHING, "goldsmithing");
    set_skill_type(SK_GOLDSMITHING, SKTYPE_CRAFTING);
    skillo(SK_WOODWORKING, "woodworking");
    set_skill_type(SK_WOODWORKING, SKTYPE_CRAFTING);
    skillo(SK_TINKERING, "tinkering");
    set_skill_type(SK_TINKERING, SKTYPE_CRAFTING);
    skillo(SK_FORGING, "forging"); //(weaponsmithing and armorsmithing)
    set_skill_type(SK_FORGING, SKTYPE_CRAFTING);
    skillo(SK_ALCHEMY, "alchemy");
    set_skill_type(SK_ALCHEMY, SKTYPE_CRAFTING);
    skillo(SK_ENCHANTING, "enchanting");
    set_skill_type(SK_ENCHANTING, SKTYPE_CRAFTING);
    skillo(SK_RUNECRAFTING, "runecrafting");
    set_skill_type(SK_RUNECRAFTING, SKTYPE_CRAFTING);
}
