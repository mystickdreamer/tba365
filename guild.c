    ...
    if (GET_ARTISAN_TYPE(ch) == 0) {
        if (!*arg) {
            send_to_char(ch, "You must select an artisan type from the following list:\r\n"
                    ...
                    "tinker (future expansion)\r\n"
                    "armorsmith ( making armor)\r\n"
            ...
            else if (!strcmp(arg, "jeweler")) {
                send_to_char(ch, "You have chosen the artisan profession of 'jeweler' giving you access to the goldsmithing and jewelry making skills.\r\n");
                GET_ARTISAN_TYPE(ch) = ARTISAN_TYPE_JEWELER;
                return;
            } else if (!strcmp(arg, "tailor")) {
                send_to_char(ch, "You have chosen the artisan profession of 'tailor' giving you access to the tailoring and cloth making skills.\r\n");
                GET_ARTISAN_TYPE(ch) = ARTISAN_TYPE_WOODSMAN;
                return;
            }
            else if (!strcmp(arg, "tinker")) {
                send_to_char(ch, "You have chosen the artisan profession of 'tinker' this is for future expansion.\r\n");
            ...
            else if (!strcmp(arg, "weaponsmith")) {
                send_to_char(ch, "You have chosen the artisan profession of 'weaponsmith' giving you access to skills that allow you to make weapons.\r\n");
                GET_ARTISAN_TYPE(ch) = ARTISAN_TYPE_WEAPONSMITH;
                return;
            }
            else {
                send_to_char(ch, "You must select an artisan type from the following list:\r\n"
